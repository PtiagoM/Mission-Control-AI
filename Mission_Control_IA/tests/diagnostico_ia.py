...
def imprimir_diagnostico_telemetria(indice: int, diagnostico: dict) -> None:
    ...
    print(f"Validacao: {'OK' if diagnostico['validacao_ok'] else diagnostico['motivo_validacao']}")
...
def main() -> None:
    print("=" * 72)
    print("DIAGNOSTICO IA - MISSION CONTROL IA".center(72))
    print("=" * 72)
    ...
    if analise.get("erro_tecnico"):
        print(f"Erro tecnico: {analise['erro_tecnico']}")
    print()
    ...
    print("Resumo")
    print(f"Telemetrias validas: {validas}/3")
