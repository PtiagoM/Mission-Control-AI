...
MISSION_CONTROL_IA_TIMEOUT_STATUS=1.5
MISSION_CONTROL_IA_TIMEOUT_TELEMETRIA=12.0
MISSION_CONTROL_IA_TIMEOUT_ANALISE=20.0
MISSION_CONTROL_IA_TIMEOUT_RELATORIO=30.0
```
